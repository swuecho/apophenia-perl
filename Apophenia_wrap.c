...
XS(_wrap_apop_vector_log) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: apop_vector_log(v);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_gsl_vector, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "apop_vector_log" "', argument " "1"" of type '" "gsl_vector *""'"); 
    }
    arg1 = (gsl_vector *)(argp1);
    apop_vector_log(arg1);
...
XS(_wrap_apop_vector_sum) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: apop_vector_sum(in);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_gsl_vector, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "apop_vector_sum" "', argument " "1"" of type '" "gsl_vector const *""'"); 
    }
    arg1 = (gsl_vector *)(argp1);
    result = (long double)apop_vector_sum((gsl_vector const *)arg1);
